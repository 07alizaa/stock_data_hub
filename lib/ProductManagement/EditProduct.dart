...
class _EditproductState extends State<Editproduct> {
  ...
  void _saveProduct() {
    if (_formKey.currentState!.validate()) {
      ...
      // Save edited product details (add your logic here)
      print(
        'Product updated: $productName, Quantity: $productQuantity, Description: $productDescription, Price: $productPrice, Low Stock Threshold: $lowStockThreshold, Demand Forecast: $demandForecast',
      );
    }
  }
}
